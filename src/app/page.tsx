  ...
  return (
    <div className="flex flex-col items-center min-h-screen w-full bg-primary text-white scroll-smooth">
      ...
      <section
        id="about"
        ref={aboutRef}
        className={`relative flex flex-shrink-0 items-center justify-center text-center py-16 px-4 flex-1 overflow-auto scroll-smooth w-full max-w-screen-lg transition-opacity duration-1000 ${aboutVisible ? 'opacity-100' : 'opacity-0'}`}
      >
        <div>
